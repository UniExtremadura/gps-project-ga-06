...
class AuthorDetailFragment : Fragment() {
    ...
    private fun subscribeUI() {
        ...
        viewModel.isFavorite.observe(viewLifecycleOwner) { isFavorite ->
            if (isFavorite) {
                binding.btnFavoriteAuthor.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.yellow))
            } else {
                binding.btnFavoriteAuthor.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.purple))
            }
        }
