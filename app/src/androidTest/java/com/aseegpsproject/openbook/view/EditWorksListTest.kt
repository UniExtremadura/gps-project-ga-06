...
class EditWorksListTest {
    ...
    fun editWorksListTest() {
        ...
        appCompatEditText4.perform(replaceText("dummyTestEditWorksList"), closeSoftKeyboard())
        ...
        val textView3 = onView(
            allOf(
                withId(R.id.tv_worklist_name), withText("dummyTestEditWorksList"),
                withParent(withParent(withId(R.id.cvWorklistItem))),
                isDisplayed()
            )
        )
        textView3.check(matches(withText("dummyTestEditWorksList")))
        ...
        val textView4 = onView(withId(R.id.work_title))
        textView4.check(matches(isDisplayed()))

        val recyclerView5 = onView(withId(R.id.rv_worklist_list))
